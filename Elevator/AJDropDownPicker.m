...
#define kDefaultHeightRow 30
#define kDefaultWeightRow 20
#define kTransitionDuration 0.6
#define backColor [UIColor colorWithRed:180.0/255.0 green:180.0/255.0 blue:180.0/255.0 alpha:1]
...
- (id)initWithDelegate:(id)delegate dataSourceArray:(NSArray *)dataSourceArray
{
    ...
    if (self) {
        ...
        pickerTableView.layer.borderColor = [UIColor grayColor].CGColor;
        ...
        pickerTableView.separatorInset = UIEdgeInsetsMake(0, 0, 0, -50);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.separatorInset = UIEdgeInsetsMake(0, 0, 0, -50);
    return cell;
}
